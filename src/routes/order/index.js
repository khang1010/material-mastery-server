...
router.get(
  '/customer/number',
  asyncHandler(OrderController.getNumberOfOrdersByCustomer)
);
router.get('/find/:id', asyncHandler(OrderController.getOrderById));
router.patch(
  '/cancel/:id',
  asyncHandler(OrderController.cancelProductByCustomer)
);
router.patch(
  '/confirm/:id',
  asyncHandler(OrderController.confirmDeliveredByCustomer)
);
...
router.patch(
  '/status/:id',
  asyncHandler(OrderController.updateOrderStatusById)
);
router.get(
  '/number',
  asyncHandler(OrderController.getNumberOfOrderByTimeRange)
);
router.post('/route', asyncHandler(OrderController.getRouteForListOrders));
